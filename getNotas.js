...
var listaServicos = JSON.parse(fs.readFileSync(__dirname + '/listaServicos.json', 'utf8'));

//recupera a lista de todas as cidades do Brasil armazenadas em um JSON
var listaCidades = JSON.parse(fs.readFileSync(__dirname + '/listaCidades.json', 'utf8'));
